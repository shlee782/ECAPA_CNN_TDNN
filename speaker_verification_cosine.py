...
if __name__ == "__main__":
    ...
    pretrain = Pretrainer(collect_in='model_local', loadables={'model': params["embedding_model"]}, paths={'model': 'results/ecapa_cnn_tdnn_vox2/1986/save/CKPT+2023-06-27+17-57-54+00/embedding_model.ckpt'})
